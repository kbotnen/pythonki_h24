...
# Load the model
model = load_model("data/converted_keras/keras_model.h5", custom_objects=custom_objects, compile=False)

# Load the labels
class_names = open("data/converted_keras/labels.txt", "r").readlines()
...
images, imagenames = stillimages('data/fruits_test')
i = 0
for image in images:
